  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 px-4 py-10 md:px-20">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold text-indigo-700 mb-8 border-b-4 border-indigo-100 pb-2">
          About Me
        </h1>
        ...
        <h2 className="text-2xl font-bold text-indigo-700 mt-10 mb-4">More About Me</h2>
